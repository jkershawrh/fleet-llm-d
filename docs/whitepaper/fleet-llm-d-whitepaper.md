...
The control plane is implemented in Go 1.26.5 using standard library HTTP for the REST API. It consists of a single binary, `fleet-controller`, that hosts seven capability packages and a REST API server.
