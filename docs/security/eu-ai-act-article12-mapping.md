...
| Soak-tested durability | 253 chains verified over 30 hours | `test/soak/` results in `docs/soak-results-july2026.md` |
...
- `docs/security-audit-checklist.md` -- overall audit status
